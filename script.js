  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        if (firstError) {
          firstError.focus();
          var errorTop = firstError.getBoundingClientRect().top + window.pageYOffset - (navbar ? navbar.offsetHeight + 20 : 20);
          window.scrollTo({ top: errorTop, behavior: 'smooth' });
        }
      }
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Gemp משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f76ef1a0-6484-4970-99b6-32717dad3d3b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f76ef1a0-6484-4970-99b6-32717dad3d3b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f76ef1a0-6484-4970-99b6-32717dad3d3b';
